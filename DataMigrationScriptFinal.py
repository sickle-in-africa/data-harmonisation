...
# python DataMigrationScriptFinal.py SCDRegistry_DATA.csv MappingFile.tsv SADaCCVariables.tsv
	...
	fw = open('/content/drive/MyDrive/SCDO-Workshop/Data-Migration/Outputs/Site-SADaCC_Mapping_Annotation.tsv', 'w')
	...
	fw = open('/content/drive/MyDrive/SCDO-Workshop/Data-Migration/Outputs/testing-data_Harmonized.csv', 'w')
	...
	fw = open('/content/drive/MyDrive/SCDO-Workshop/Data-Migration/Outputs/SADaCCVariables_MappedToSite.csv', 'w')
	header = fp.readline()
  ...
  #print SADaCCMapped
	...
	fw = open('/content/drive/MyDrive/SCDO-Workshop/Data-Migration/Outputs/Site_HarmonizedDictionary.tsv', 'w')
	fw.write(header)
	...
	outputs = ['/content/drive/MyDrive/SCDO-Workshop/Data-Migration/Outputs/Site-SADaCC_Mapping_Annotation.tsv', 
  '/content/drive/MyDrive/SCDO-Workshop/Data-Migration/Outputs/testing-data_Harmonized.csv', 
  '/content/drive/MyDrive/SCDO-Workshop/Data-Migration/Outputs/SADaCCVariables_MappedToSite.csv', 
  '/content/drive/MyDrive/SCDO-Workshop/Data-Migration/Outputs/Site_HarmonizedDictionary.tsv']

	n = max([len(a) for a in outputs])

	print("\nThe process has now been fully completed and following four files has been produced:\n")
	print("   - testing-data_Harmonized.csv"+" (The harmonized new data sets)")
	print("   - Site-SADaCC_Mapping_Annotation.tsv"+" (Mapped variables annotation file)")
	print("   - Site_HarmonizedDictionary.tsv"+" (New site harmonized dictionary)")
	print("   - SADaCCVariables_MappedToSite.csv"+" (The SADaCC variables mapped to the site dictionary)")
	print(100*'*')
